        ...
        layui.each(r, function(a, r) {
            var l = r.children && r.children.length > 0
              ...
              , h = i(['<div data-id="' + r.id + '" class="layui-tree-set' + (r.spread ? " layui-tree-spread" : "") + (r.checked ? " layui-tree-checkedFirst" : "") + '">', '<div class="layui-tree-entry">', '<div class="layui-tree-main">', function() {
                ...
                return t.isJump && r.href ? '<a href="' + r.href + '" target="_blank" class="' + y + '">' + (r.title || r.label || t.text.defaultNodeName) + "</a>" : '<span class="' + y + (r.disabled ? " " + d : "") + (r.isbigdata ? " " +"glyphicon glyphicon-star":"") + '">' + (r.title || r.label || t.text.defaultNodeName) + "</span>"
            }(), "</div>", function() {
                if (!t.edit)
                    return "";
                var e = {
        ...
        l.children(".layui-tree-btnGroup").on("click", ".layui-icon", function(l) {
            ...
            if ("add" == f) {
                ...
                var w = r.operate && r.operate(g)
                  , N = {};
                r.text.defaultNodeName=t.tempData;
